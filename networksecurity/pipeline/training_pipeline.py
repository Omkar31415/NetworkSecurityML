...
class TrainingPipeline:
    ...
    def start_model_trainer(self,data_transformation_artifacts:DataTransformationArtifact)->ModelTrainerArtifact:
        try:
            ...
            model_trainer=ModelTrainer(self.model_trainer_config,data_transformation_artifacts)
    ...
    def sync_artifact_dir_to_s3(self):
        try:
            ...
            logging.info("Saved artifacts synced to S3 Bucket!")
        except Exception as e:
            raise NetworkSecurityException(e,sys)
    ...
    def sync_saved_model_dir_to_s3(self):
        try:
            ...
            logging.info("Saved model synced to S3 Bucket!")
        except Exception as e:
            raise NetworkSecurityException(e,sys)
