...
from networksecurity.entity.artifact_entity import ModelTrainerArtifact,DataIngestionArtifact,DataValidationArtifact,DataTransformationArtifact
...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        try:
            ...
            logging.info("Data Ingestion Completed and Artifact: ",self.data_ingestion_artifact)
    ...
    def start_model_trainer(self,data_transformation_artifacts:DataTransformationArtifact)->ModelTrainerArtifact:
        try:
            ...
            self.model_trainer=ModelTrainer(self.model_trainer_config,data_transformation_artifacts)
            self.model_trainer_artifact=self.model_trainer.initiate_model_trainer()
            logging.info("Model Training Artifact created: ", self.model_trainer_artifact)
    ...
    def run_pipeline(self):
        try:
            ...
            data_tranformation_artifact=self.start_data_transformation(data_validation_artifact)
