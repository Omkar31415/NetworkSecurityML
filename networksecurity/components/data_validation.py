...
class DataValidation:
    ...
    def validate_number_of_columns(self,dataframe:pd.DataFrame)->bool:
        try:
            ...
            logging.info(f"Required number of colummns:{number_of_columns}")
    ...
    def validate_numerical_columns(self,dataframe:pd.DataFrame)->bool:
        try:
            return not dataframe.select_dtypes(include=['number']).empty
        except Exception as e:
            raise NetworkSecurityException(e,sys)
    ...
    def detect_dataset_drift(self,base_df,current_df,threshold=0.05)->bool:
        try:
            ...
            for column in base_df.columns:
                ...
                is_sample_dist=ks_2samp(data1=d1,data2=d2)
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            #let's check datadrift for both train and test datasets, because the type of distribution or varibales should be same in both so that only model can predict good.
